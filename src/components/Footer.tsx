      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="hidden md:flex items-center gap-6">
              <div className="flex flex-col items-center gap-1">
                <div className="w-[728px] h-[90px] bg-orange-200 border-2 border-orange-300"></div>
                <a
                  href="https://www.bannerbedlam.com/?ref=vextorgrid"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-500 text-xs hover:text-[#008080] transition-colors"
                >
                  banner ads provided by: BannerBedlam.com
                </a>
              </div>
              {variant === 'public' ? (
          ...
          <div className="md:hidden flex flex-col items-center gap-1">
            <div className="w-[320px] h-[50px] bg-orange-200 border-2 border-orange-300"></div>
            <a
              href="https://www.bannerbedlam.com/?ref=vextorgrid"
              target="_blank"
              rel="noopener noreferrer"
