          ...
          <div className="bg-[#1a1a1a] border-4 border-[#DC143C] max-w-lg w-full">
            ...
            <div className="p-6">
              <p className="text-white mb-4" style={{ fontFamily: 'monospace' }}>
                Operator, your Garage is full.
              </p>
              <p className="text-gray-400 mb-6">
                Upgrade to <span className="text-[#FF4500] font-bold">Vextor Command (Premium)</span> to manage
                unlimited vehicles and unlock advanced features.
              </p>
              <div className="bg-[#252525] border border-[#333] p-4 mb-6">
                <p className="text-[#008080] text-sm" style={{ fontFamily: 'monospace' }}>
                  [COMING SOON]
                </p>
              </div>
